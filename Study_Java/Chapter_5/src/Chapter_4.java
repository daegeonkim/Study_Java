...
public class Chapter_4 {
	...
	public double mSalary(int ySalary){ 
		...
		double month_Salary = ySalary/12;		// 셀러리 개월수로 나
		double taxx1 = c_Tax1(month_Salary);
		double taxx2 = c_Tax1(month_Salary);
		double taxx3 = c_Tax1(month_Salary);
		...
		System.out.print("Your Total Salary is "+total_Tax);
	...
	public double c_Tax3(double month_Salary){
		double tax3 = month_Salary *(100/13.5);
		return tax3;
	}
}
